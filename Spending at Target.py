...
x = numpy.random.normal(6, 2, 100)  # Gens data from a normal dist with mean 6, SD 2, and 100 elements.
y = numpy.random.normal(300, 80, 100) / x
...
regline = numpy.linspace(0, 10, 100)  # Generate 100 evenly-spaced values between 0 and 10.
...
axs[0].set_xlabel('Time Spent Shopping')  # Label x-axis.
...
axs[1].set_xlabel('Time Spent Shopping')  # Label the x-axis.
...
axs[2].set_title('Actual Data of Wife Shopping at Target')  # Set title for this subplot.
axs[2].set_xlabel('Time Spent Shopping')  # Label the x-axis.
